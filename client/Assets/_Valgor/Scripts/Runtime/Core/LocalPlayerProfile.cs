...
namespace Valgor.Core
{
    ...
    public static class LocalPlayerProfile
    {
        ...
        public static bool Create(string displayName, out string error)
        {
            ...
            PlayerPrefs.SetInt(KeyTutorialStep, TutorialSteps.Welcome);
            SeedStartingEnergy();
            PlayerPrefs.Save();
            error = string.Empty;
            return true;
        ...
        {
            if (session == null || !HasProfile) return;
            if (!session.IsActive) session.Begin();
        ...
        public static bool CanContinue() => HasProfile && HasDomainSave();
        ...
        {
            // Meta gates are enough for repositories to treat as fresh seed.
        ...
        public static class TutorialSteps
        {
            ...
            public const int OpenHeroes = 1;
            public const int DragonTower = 2;
            public const int OpenMap = 3;
            public const int MarchGather = 4;
            public const int ReturnCity = 5;
