...
namespace Valgor.Heroes.EditorTools
{
    public static class HeroesCatalogBuilder
    {
        ...
        private static readonly HeroSeedRow[] Rows =
        {
            ...
            new("HERO_CONSORTE_002", "Lyra", "A Consorte de Valgor", HeroFaction.GuardaDaOrdem, HeroRarity.Mitica, "Lanceira Real", "Suporte / Liderança / Dano", "Linha intermediária", "Lança-cajado celestial branca e dourada", "Luz Sagrada", "Voto Eterno", 10f, 45f),
            new("HERO_SOMBRA_003", "Nyx", "A Arqueira da Sombra", HeroFaction.RosaDeSangue, HeroRarity.Lendaria, "Atiradora Élfica", "Dano / Controle", "Retaguarda", "Besta élfica ornamentada", "Sombra", "Domínio Sombrio", 8f, 42f),
            ...
            new("HERO_ABISMO_007", "Selene", "A Maga do Abismo", HeroFaction.AsasDoAmanhecer, HeroRarity.Lendaria, "Maga", "Dano em área / Controle / Enfraquecimento", "Retaguarda", "Cajado do Abismo com orbe violeta", "Abismo", "Domínio do Vazio", 7f, 50f),
