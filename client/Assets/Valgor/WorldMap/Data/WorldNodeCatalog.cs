    ...
    public static class WorldNodeCatalog
    {
        ...
        private static Dictionary<string, WorldMapNodeDefinition> Build()
        {
            ...
            var nodes = new List<WorldMapNodeDefinition>
            {
                ...
                new WorldResourceNode("forest-wood", "forest", "Bosque de Carvalho", "Madeira acumulada na clareira.", WorldNodeStatus.Available, -10f, 10f, ResourceType.Wood, 800),
                ...
                new WorldResourceNode("mount-iron", "mountains", "Veio de Ferro", "Minério a céu aberto.", WorldNodeStatus.Available, 12f, 10f, ResourceType.Iron, 500),
                ...
                new WorldResourceNode("coast-gold", "coast", "Banco de Conchas", "Ouro lavado pela maré.", WorldNodeStatus.Available, -11f, -8f, ResourceType.Gold, 350),
                ...
                new WorldResourceNode("desert-stone", "desert", "Pedreira de Vidro", "Bloqueada pelo calor.", WorldNodeStatus.Locked, 14f, -8f, ResourceType.Stone, 600),
