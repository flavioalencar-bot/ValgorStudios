...
namespace Valgor.Dragons.Core
{
    public sealed class DragonStateMachine
    {
        ...
        {
            [DragonState.Locked] = new() { DragonState.Hatching },
            [DragonState.Hatching] = new() { DragonState.Resting },
            [DragonState.Resting] = new() { DragonState.Hungry, DragonState.Ready },
            [DragonState.Hungry] = new() { DragonState.Resting, DragonState.Ready },
            [DragonState.Ready] = new() { DragonState.Flying, DragonState.Hungry, DragonState.Resting },
            [DragonState.Flying] = new() { DragonState.Combat, DragonState.Exhausted, DragonState.Resting },
            [DragonState.Combat] = new() { DragonState.Exhausted, DragonState.Injured, DragonState.Flying },
